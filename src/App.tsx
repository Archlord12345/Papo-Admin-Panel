...
function App() {
  ...
  const login = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setMessage(error instanceof Error ? error.message : 'Connexion Supabase indisponible.');
    } finally {
      setLoading(false);
    }
  };
